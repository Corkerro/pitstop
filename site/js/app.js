(() => {
    ...
    function initSliders() {
        if (document.querySelector(".discontswiper")) new swiper_core_Swiper(".discontswiper", {
            ...
            lazy: true,
            pagination: {
                el: ".discontswiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".discontswiper-button-prev",
                nextEl: ".discontswiper-button-next"
            },
            breakpoints: {
                0: {
                    centeredSlides: true
